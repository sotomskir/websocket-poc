package pl.sotomski.wspoc.gateway.repository;

import pl.sotomski.wspoc.gateway.GatewayApp;
import pl.sotomski.wspoc.gateway.config.Constants;
import pl.sotomski.wspoc.gateway.config.audit.AuditEventConverter;
import pl.sotomski.wspoc.gateway.domain.PersistentAuditEvent;
...
import static pl.sotomski.wspoc.gateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
